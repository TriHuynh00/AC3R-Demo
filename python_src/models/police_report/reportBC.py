from models.police_report import Report, CAT_BC_DATA
...
class ReportTypeBC(Report):
    ...
    def process(self, outputs: list, targets: list) -> Tuple[int, int, int]:
        ...
        crashes_from_police_report, non_crashes_from_police_report = targets, list(set(CAT_BC_DATA) - set(targets))
        ...
        crashes_from_simulation, non_crashes_from_simulation = outputs, list(set(CAT_BC_DATA) - set(outputs))

        crash_points, non_crash_points = self._match(CAT_BC_DATA,
