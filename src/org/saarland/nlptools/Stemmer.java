...
// CITE https://github.com/stanfordnlp/CoreNLP/blob/master/src/edu/stanford/nlp/process/Stemmer.java
...
//            while (it.hasNext()) {
//                Word token = it.next();
//                ConsoleLogger.print('n',s.stem(token.word()));
//                ConsoleLogger.print('n',' ');
//            }
//        } else {
//            for (String arg : args) {
//                ConsoleLogger.print('n',s.stem(arg));
//                ConsoleLogger.print('n',' ');
//            }
//        }
